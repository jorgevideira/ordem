                ...
                <table class="table table-bordered dataTable"  width="100%" cellspacing="0">
                  <thead>
                    ...
                    <tr>
                      ...
                      <td class="text-center pr-4"><?php echo ($vendedor->vendedor_ativo == 1 ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>')?></td>
                      <td class="text-right">
