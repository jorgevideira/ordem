    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo $titulo; ?></li>
        ...
        <fieldset class="mt-4 border p-2">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-3">
                    <label> RG </label>
                    <input type="text" class="form-control form-control-user rg" name="vendedor_rg" placeholder="RG vendedor" value="<?php echo set_value('vendedor_rg'); ?>">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-3">
                    <label> Celular </label>
                    <input type="text" class="form-control form-control-user sp_celphones" name="vendedor_celular" placeholder="Celular vendedor" value="<?php echo set_value('vendedor_celular'); ?>">
                    <?php echo form_error('vendedor_celular','<small class="form-text text-danger">','</small>');?>
                </div>
                
                <div class="col-md-3">
                    <label> Telefone fixo </label>
                    <input type="text" class="form-control form-control-user sp_celphones" name="vendedor_telefone" placeholder="Tel. fixo vendedor" value="<?php echo set_value('vendedor_telefone'); ?>">
        ...
        <fieldset class="mt-4 border p-2">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-user" name="vendedor_endereco" placeholder="Endereço vendedor" value="<?php echo set_value('vendedor_endereco'); ?>">
                    <?php echo form_error('vendedor_endereco','<small class="form-text text-danger">','</small>');?>
                </div>
                
                <div class="col-md-2">
                    <label> Número </label>
                    <input type="text" class="form-control form-control-user " name="vendedor_numero_endereco" placeholder="N°" value="<?php echo set_value('vendedor_numero_endereco'); ?>">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-4">
                    <label> Bairro </label>
                    <input type="text" class="form-control form-control-user" name="vendedor_bairro" placeholder="Bairro vendedor" value="<?php echo set_value('vendedor_bairro'); ?>">
                ...
                <div class="col-md-5">
                    <label> Cidade </label>
                    <input type="text" class="form-control form-control-user" name="vendedor_cidade" placeholder="Cidade do vendedor" value="<?php echo set_value('vendedor_cidade'); ?>">
