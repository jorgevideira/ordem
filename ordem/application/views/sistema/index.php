    ...
    <?php endif; ?>  
          ...
          <div class="card shadow mb-4">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-3">
                    <label> Celular </label>
                    <input type="text" class="form-control form-control-user sp_celphones" name="sistema_telefone_movel" placeholder="Celular" value="<?php echo $sistema->sistema_telefone_movel; ?>">
                ...
                <div class="col-md-3">
                    <label> Site </label>
                    <input type="text" class="form-control form-control-user" name="sistema_site_url" placeholder="Site" value="<?php echo $sistema->sistema_site_url; ?>">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-1">
                    ...
                    <input type="text" class="form-control form-control-user" name="sistema_complemento" placeholder="Comple." value="<?php echo $sistema->sistema_complemento; ?>">
                    <?php echo form_error('sistema_complemento','<small class="form-text text-danger">','</small>');?>
                </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-12">
                    <label> Texto para ordem de serviço </label>
                    <textarea class="form-control form-control-user" name="sistema_txt_ordem_servico" placeholder="Texto para ordem de serviço" ><?php echo $sistema->sistema_txt_ordem_servico; ?></textarea>
