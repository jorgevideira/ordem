        ...
        <fieldset class="mt-4 border p-2">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-user" name="fornecedor_razao" placeholder="Razão social fornecedor" value="<?php echo $fornecedor->fornecedor_razao; ?>">
                    <?php echo form_error('fornecedor_razao','<small class="form-text text-danger">','</small>');?>
                </div>
                
                <div class="col-md-6">
                    <label> Nome fantasia </label>
                    <input type="text" class="form-control form-control-user" name="fornecedor_nome_fantasia" placeholder="Nome fantasia fornecedor" value="<?php echo $fornecedor->fornecedor_nome_fantasia; ?>">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-4">
                    <label> Celular </label>
                    <input type="text" class="form-control form-control-user sp_celphones" name="fornecedor_celular" placeholder="Celular fornecedor" value="<?php echo $fornecedor->fornecedor_celular; ?>">
                    <?php echo form_error('fornecedor_celular','<small class="form-text text-danger">','</small>');?>
                </div>
                
                <div class="col-md-4">
                    <label> E-mail </label>
                    <input type="email" class="form-control form-control-user" name="fornecedor_email" placeholder="E-mail fornecedor" value="<?php echo $fornecedor->fornecedor_email; ?>">
        ...
        <fieldset class="mt-4 border p-2">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-user" name="fornecedor_endereco" placeholder="Endereço fornecedor" value="<?php echo $fornecedor->fornecedor_endereco; ?>">
                    <?php echo form_error('fornecedor_endereco','<small class="form-text text-danger">','</small>');?>
                </div>
                
                <div class="col-md-2">
                    <label> Número </label>
                    <input type="text" class="form-control form-control-user " name="fornecedor_numero_endereco" placeholder="N°" value="<?php echo $fornecedor->fornecedor_numero_endereco; ?>">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-4">
                    <label> Bairro </label>
                    <input type="text" class="form-control form-control-user" name="fornecedor_bairro" placeholder="Bairro fornecedor" value="<?php echo $fornecedor->fornecedor_bairro; ?>">
                ...
                <div class="col-md-5">
                    <label> Cidade </label>
                    <input type="text" class="form-control form-control-user" name="fornecedor_cidade" placeholder="Cidade do fornecedor" value="<?php echo $fornecedor->fornecedor_cidade; ?>">
