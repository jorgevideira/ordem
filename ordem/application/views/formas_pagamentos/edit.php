          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <p><strong><i class="fas fa-user-clock"></i>&nbsp;&nbsp;Última alteração: </strong>&nbsp;<?php echo formata_data_banco_com_hora($forma_pagamento->forma_pagamento_data_alteracao); ?></p>
            
        <fieldset class="mt-4 border p-2">
                        
                        <legend class="font-small"><i class="fab fa-buffer">&nbsp;Dados da forma de pagamento </i> </legend>
                        
            <div class="form-group row mb-3">
                
                <div class="col-md-6 mb-3">
                    <label> Nome da forma de pagamento </label>
                    <input type="text" class="form-control form-control-user" name="forma_pagamento_nome" placeholder="Nome da forma" value="<?php echo $forma_pagamento->forma_pagamento_nome; ?>">
            ...
            <a title="Voltar" href="<?php echo base_url('modulo'); ?>" class="btn btn-success btn-sm ml-2 mt-4">Voltar</a>
          </form>
