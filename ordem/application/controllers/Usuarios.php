...
class Usuarios extends CI_Controller{
    ...
    public function index() {
        ...
        if (!$this->ion_auth->is_admin()){
         $this->session->set_flashdata('info', 'Você não tem permissão para acessar o menu Usuarios');
         redirect('/');
     }
    ...
    public function add () {
     ...
     if (!$this->ion_auth->is_admin()){
         ...
         redirect('/');
            ...
            $this->form_validation->set_rules('username','','trim|required|is_unique[users.username]|min_length[5]|max_length[255]');
    ...
    public function edit($usuario_id = NULL) {
        ...
        // se não for user e tentar editar um usuario diferente do seu
        if(!$this->ion_auth->is_admin()){
            if(($this->session->userdata('user_id') != $usuario_id)){
           $this->session->set_flashdata('info','Você não pode editar um usuario diferente do seu! ');
            redirect('/');     
            }    
        }
