           ...
           // true faz o download
            $this->pdf->createPDF($html, $file_name, false, 'A4');
                ...
                if(!empty($data_inicial)&& !empty($data_final)){
                    $this->session->set_flashdata('info', 'Não foram encontradas vendas entre as datas &nbsp'. formata_data_banco_sem_hora($data_inicial). '&nbsp;e&nbsp;'. formata_data_banco_sem_hora($data_final));
                } else {
                    $this->session->set_flashdata('info', 'Não foram encontradas vendas a partir da data informada &nbsp;'. formata_data_banco_sem_hora($data_inicial));
...
//           exit();
           ...
           // true faz o download
            $this->pdf->createPDF($html, $file_name, false, 'A4');
                ...
                if(!empty($data_inicial)&& !empty($data_final)){
                    $this->session->set_flashdata('info', 'Não foram encontradas ordens de serviços entre as datas &nbsp'. formata_data_banco_sem_hora($data_inicial). '&nbsp;e&nbsp;'. formata_data_banco_sem_hora($data_final));
                } else {
                    $this->session->set_flashdata('info', 'Não foram encontradas ordens de serviços a partir da data informada &nbsp;'. formata_data_banco_sem_hora($data_inicial));
...
//           exit();
           ...
           // true faz o download
            $this->pdf->createPDF($html, $file_name, false, 'A4');
                   ...
                   $this->session->set_flashdata('info', 'Não exixtem contas vencidas na base de dados');
...
//           exit();
           ...
           // true faz o download
            $this->pdf->createPDF($html, $file_name, false, 'A4');
                   ...
                   $this->session->set_flashdata('info', 'Não exixtem contas pagas na base de dados');
                   redirect('relatorios/receber');
...
//           exit();
           ...
           // true faz o download
            $this->pdf->createPDF($html, $file_name, false, 'A4');
                   ...
                   $this->session->set_flashdata('info', 'Não exixtem contas a receber na base de dados');
                   redirect('relatorios/receber');
    ...
    public function pagar() {
       ...
       if($contas == 'pagas' || $contas == 'vencidas' || $contas == 'a_pagar'){
           ...
           $html .='</tr>';           
            ...
            $html .='<td style="border-top: solid #ddd 1px"><strong>Valor final</strong></td>';
            $html .='<td style="border-top: solid #ddd 1px">'.'R$&nbsp;' . $valor_final_contas->conta_paga_valor_total.'</td>';
...
//           exit();
           ...
           // true faz o download
            $this->pdf->createPDF($html, $file_name, false, 'A4');
                   ...
                   $this->session->set_flashdata('info', 'Não exixtem contas a Pagar na base de dados');
                   redirect('relatorios/pagar');
